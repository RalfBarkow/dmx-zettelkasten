...
This a plugin for the https://github.com/dmx-systems/dmx-platform[DMX Knowledge Building Platform] based on https://github.com/dmx-systems/dmx-plugin-template[this Template].
